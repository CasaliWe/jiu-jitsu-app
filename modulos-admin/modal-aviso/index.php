...
<div class="modal fade" id="modalAviso-delete" tabindex="-1" aria-labelledby="modalAviso-delete" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content px-3">
                <div class="py-4 modal-header d-flex flex-column">
                    <h6 class="modal-title fs-5 mb-4 text-center" id="exampleModalLabel">Deletado com sucesso! <i class="ms-2 fas fa-check-square text-success"></i></h6>
...
<div class="modal fade" id="modalAviso-error-password" tabindex="-1" aria-labelledby="modalAviso-error-password" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content px-3">
                <div class="py-4 modal-header d-flex flex-column">
                    <h6 class="modal-title fs-5 mb-4 text-center" id="exampleModalLabel">Falha no processo, por favor <br> verifique as senhas e tente novamente! <i class="ms-2 fas fa-exclamation-triangle text-danger"></i> </h6>
                    <button onclick="reescreverRota('error-password')" type="button" class="w-25 btn btn-danger" data-bs-dismiss="modal" aria-label="Close"> Fechar </button>
                </div>
        </div>
    </div>
</div>
...
<?php if(isset($_GET['error-password']) && $_GET['error-password'] == "true"){ ?>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
        var modalVaga = new bootstrap.Modal(document.getElementById('modalAviso-error-password'));
        modalVaga.show();
        });
    </script>
<?php } ?>
